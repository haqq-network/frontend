    ...
    <div className="container mx-auto px-2 sm:px-6 lg:px-8">
      <div className="mx-auto my-[58px] max-w-lg">
              ...
              <div className="flex flex-row gap-[16px]">
                {user && (
                  <div className="flex flex-1 flex-row items-center space-x-4">
                    ...
                    <p className="text-[18px] font-[500] leading-[28px] text-white">
                      {user.nickname}
                    </p>
                  </div>
                )}
        ...
        {isAuthenticated && address && (
          <div className="flex flex-col gap-[16px] rounded-b-[8px] bg-[#FFFFFF26] px-[28px] py-[32px]">
            <div className="flex flex-row items-center">
              <EarnIcon className="h-[28px] w-[28px]" />
              <Heading level={3} className="mb-[-2px] ml-[8px]">
                Claim tokens
              </Heading>
            </div>
              ...
              <Fragment>
                ...
                {isTokensClaimed && (
                  <div className="flex flex-row items-center gap-[12px]">
                    <SuccessIndicator size="44px" color="#157C83" />
                    <p className="text-[18px] font-[500] leading-[28px] text-white">
                      Tokens claimed!
                    </p>
                  </div>
