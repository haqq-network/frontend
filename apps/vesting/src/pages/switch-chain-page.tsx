...
import { AlertWithDetails } from '../components/modals/AlertWithDetails/AlertWithDetails';
      ...
      <Container>
        <div className="mx-auto max-w-[600px] py-20">
          <div className="flex flex-col space-y-8">
            ...
            <div>
              <Text color="light">
                To continue you should switch to our network. Use button bellow
                to do that.
              </Text>
            </div>
            ...
            <div className="mt-[24px] flex flex-col items-center justify-between md:flex-row">
              <SwitchNetworkNetworkContainer
                networkName={chainId ? toHex(chainId) : 'unknown'}
              />
                ...
                <Button
                  onClick={async () => {
                    try {
                      ...
                      setSwitchChainError((error as Error).message);
                    }
                  }}
