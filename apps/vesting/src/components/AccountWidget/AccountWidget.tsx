...
import { CopyIcon, ScanIcon } from '../Icons/Icons';
      ...
      <div className="flex flex-row space-x-2 items-center h-[48px] flex-1">
        ...
        <div className="flex flex-col space-1-2">
          ...
          <div className="flex flex-row space-x-1 items-center">
            ...
            >
              <CardIconButton>
                <ScanIcon className="text-white/60 hover:text-white cursor-pointer transition-colors duration-150" />
              </CardIconButton>
            </a> */}
          </div>
        </div>
