...
export function RecentPostsBlock({ recentPosts }: { recentPosts: Post[] }) {
  ...
  return (
    <section className="flex flex-col items-start pb-[48px] md:pb-[68px] lg:pb-[100px]">
      <div className="w-full overflow-clip px-[16px] sm:px-[48px] lg:px-[80px]">
        <div className="mx-auto max-w-4xl xl:max-w-[804px]">
          <div className="mb-[28px] lg:mb-[32px]">
            <h2 className="ltr:font-vcr rtl:font-handjet text-[17px] leading-[26px] md:text-[18px] lg:text-[20px] lg:leading-[28px]">
              Related articles
            </h2>
          </div>
