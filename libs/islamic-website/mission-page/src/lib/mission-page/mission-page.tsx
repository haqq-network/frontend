...
export function MissionPage() {
  return (
    <div>
      <Container className="mt-[32px] flex flex-col gap-y-[32px] text-white md:mt-[52px] lg:mt-[68px]">
        ...
        <div className="flex flex-col gap-y-[28px]">
          <div className="flex flex-col gap-y-[16px]">
            ...
            <Text>
              Our vision is to create a global, inclusive, and ethical financial
              ecosystem that aligns with Islamic principles, empowering
              individuals and businesses with accessible and transparent
              financial solutions.
            </Text>
          </div>
          <div className="flex flex-col gap-y-[16px]">
      ...
      <div className="relative overflow-clip pb-[250px] opacity-50">
        <div className="absolute bottom-0 left-1/2 z-[-1] h-[262px] w-[781px] translate-x-[-50%] transform">
          <Image src={missionRockImgData} alt="" fill />
        </div>
      </div>
    </div>
  );
