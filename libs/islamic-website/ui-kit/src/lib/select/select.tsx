    ...
    return variants.map(({ id, title }) => {
      return (
        <Menu.Item
          as="div"
          className={clsx(
            'rtl:font-handjet block w-full min-w-fit whitespace-nowrap px-[16px] py-[8px] font-mono  text-base uppercase hover:bg-[#ffffff14]',
          ...
          return (
            <button
              className={clsx(
                ...
                'rtl:font-handjet font-mono  text-base',
