    ...
    >
      ...
      >
        <div className="flex flex-col">
          <div
            className={clsx(
              'rtl:font-handjet mt-[24px] font-mono  text-[10px] font-[400] uppercase leading-[16px] text-[#838383] md:text-[11px] md:leading-[18px] lg:text-[12px]',
              isFeatured && 'md:mt-0',
            )}
          >
            {post.source}
        ...
        <div
          className={clsx(
            'rtl:font-handjet mt-[16px] font-mono  text-[10px] uppercase leading-[16px] text-[#838383] md:text-[11px] md:leading-[18px] lg:text-[12px]',
            isFeatured && 'md:mt-0',
          )}
        >
