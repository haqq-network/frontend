    ...
    <div className="overflow-x-clip">
      <Container className="relative">
        <div className="pb-[60px] pt-[32px] text-white md:pb-[140px] md:pt-[52px] lg:pt-[68px]">
          ...
          <div className="mt-[32px] flex flex-col gap-y-[16px] md:mt-[60px] md:max-w-[560px] md:gap-y-[24px]">
          ...
          <div className="mt-[32px] flex flex-col gap-y-[24px] md:mt-[60px] md:max-w-[600px] md:gap-y-[32px]">
            <DocsTab type="manual">
              Unlock the essential roadmap to transform your ideas into reality
              within the Islamic Coin ecosystem
            </DocsTab>
            <DocsTab type="archive">
              Explore the stories, insights, and groundbreaking ideas that have
              shaped the Islamic Coin ecosystem, and let history guide your path
...
function DocsTab({
  type,
  children,
}: PropsWithChildren<{ type: 'manual' | 'archive' }>) {
  return (
    <div className="group flex w-full gap-x-[12px] md:gap-x-[16px]">
      {type === 'manual' ? (
        <div>
          <svg
            viewBox="0 0 40 40"
      ...
      <div className="flex flex-col gap-y-[2px]">
        <div className="flex items-center gap-x-[6px]">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="transform-gpu transition-transform duration-300 group-hover:translate-x-[4px]"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
