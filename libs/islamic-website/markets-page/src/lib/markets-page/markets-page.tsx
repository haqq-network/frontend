...
import { useRestriction } from '../use-restriction/use-restriction';
            ...
            <div className="flex flex-col gap-[48px] md:gap-[100px]">
              ...
              <div>
                ...
                <div className="mt-[16px] flex flex-col gap-[16px] md:mt-[20px] md:gap-[24px] lg:mt-[24px]">
                  ...
                  <p>
                    <Text>
                      We encourage all potential purchasers to review their
                      local regulations and restrictions before attempting to
                      acquire ISLM tokens.
                    </Text>
                  </p>
                  <p>
