...
export function Marquee({
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 z-30 h-full w-[40px] bg-gradient-to-l from-transparent to-[#010304] md:w-[120px]" />
      <div
        className={clsx(
      ...
      <div className="absolute right-0 top-0 z-30 h-full w-[40px] bg-gradient-to-l from-[#010304] to-transparent md:w-[120px]" />
    </div>
  );
}
