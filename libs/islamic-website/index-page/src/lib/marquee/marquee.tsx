...
export function Marquee({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={clsx(
          'flex select-none gap-x-[1rem] overflow-hidden border-y border-[#2F2F2F] py-[4px] font-mono text-[15px] leading-[22px] text-white/50 md:text-base lg:text-[18px] lg:leading-[26px]',
          className,
        )}
      >
