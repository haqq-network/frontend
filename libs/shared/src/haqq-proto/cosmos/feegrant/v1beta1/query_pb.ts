...
export class QueryAllowanceResponse extends Message<QueryAllowanceResponse> {
  ...
  static equals(
    a:
      | QueryAllowanceResponse
      | PlainMessage<QueryAllowanceResponse>
      | undefined,
    b:
      | QueryAllowanceResponse
      | PlainMessage<QueryAllowanceResponse>
...
export class QueryAllowancesRequest extends Message<QueryAllowancesRequest> {
  ...
  static equals(
    a:
      | QueryAllowancesRequest
      | PlainMessage<QueryAllowancesRequest>
      | undefined,
    b:
      | QueryAllowancesRequest
      | PlainMessage<QueryAllowancesRequest>
...
export class QueryAllowancesResponse extends Message<QueryAllowancesResponse> {
  ...
  static equals(
    a:
      | QueryAllowancesResponse
      | PlainMessage<QueryAllowancesResponse>
      | undefined,
    b:
      | QueryAllowancesResponse
      | PlainMessage<QueryAllowancesResponse>
...
export class QueryAllowancesByGranterRequest extends Message<QueryAllowancesByGranterRequest> {
  ...
  static fromJsonString(
    ...
    return new QueryAllowancesByGranterRequest().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | QueryAllowancesByGranterRequest
      | PlainMessage<QueryAllowancesByGranterRequest>
      | undefined,
    b:
      | QueryAllowancesByGranterRequest
      | PlainMessage<QueryAllowancesByGranterRequest>
...
export class QueryAllowancesByGranterResponse extends Message<QueryAllowancesByGranterResponse> {
  ...
  static fromJsonString(
    ...
    return new QueryAllowancesByGranterResponse().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | QueryAllowancesByGranterResponse
      | PlainMessage<QueryAllowancesByGranterResponse>
      | undefined,
    b:
      | QueryAllowancesByGranterResponse
      | PlainMessage<QueryAllowancesByGranterResponse>
