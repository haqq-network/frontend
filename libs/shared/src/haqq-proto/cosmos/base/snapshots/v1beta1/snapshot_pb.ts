...
export class SnapshotExtensionPayload extends Message<SnapshotExtensionPayload> {
  ...
  static equals(
    a:
      | SnapshotExtensionPayload
      | PlainMessage<SnapshotExtensionPayload>
      | undefined,
    b:
      | SnapshotExtensionPayload
      | PlainMessage<SnapshotExtensionPayload>
...
export class SnapshotKVItem extends Message<SnapshotKVItem> {
  ...
  static equals(
    a: SnapshotKVItem | PlainMessage<SnapshotKVItem> | undefined,
    b: SnapshotKVItem | PlainMessage<SnapshotKVItem> | undefined,
  ): boolean {
...
export class SnapshotSchema extends Message<SnapshotSchema> {
  ...
  static equals(
    a: SnapshotSchema | PlainMessage<SnapshotSchema> | undefined,
    b: SnapshotSchema | PlainMessage<SnapshotSchema> | undefined,
  ): boolean {
