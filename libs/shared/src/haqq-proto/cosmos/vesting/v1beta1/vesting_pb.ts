...
import { BaseAccount } from '../../auth/v1beta1/auth_pb';
...
export class ContinuousVestingAccount extends Message<ContinuousVestingAccount> {
  ...
  static equals(
    a:
      | ContinuousVestingAccount
      | PlainMessage<ContinuousVestingAccount>
      | undefined,
    b:
      | ContinuousVestingAccount
      | PlainMessage<ContinuousVestingAccount>
...
export class Period extends Message<Period> {
  ...
  static equals(
    a: Period | PlainMessage<Period> | undefined,
    b: Period | PlainMessage<Period> | undefined,
  ): boolean {
...
export class PeriodicVestingAccount extends Message<PeriodicVestingAccount> {
  ...
  static equals(
    a:
      | PeriodicVestingAccount
      | PlainMessage<PeriodicVestingAccount>
      | undefined,
    b:
      | PeriodicVestingAccount
      | PlainMessage<PeriodicVestingAccount>
...
export class PermanentLockedAccount extends Message<PermanentLockedAccount> {
  ...
  static equals(
    a:
      | PermanentLockedAccount
      | PlainMessage<PermanentLockedAccount>
      | undefined,
    b:
      | PermanentLockedAccount
      | PlainMessage<PermanentLockedAccount>
