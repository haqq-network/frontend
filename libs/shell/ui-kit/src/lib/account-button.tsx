    ...
    >
      ...
      {!withoutDropdown && onDisconnectClick ? (
        <Menu as="div" className="relative z-10 inline-block h-[40px]">
          ...
          >
            <Menu.Items className="border-haqq-border absolute right-[-1px] z-10 mt-1 w-[160px] origin-top-right rounded-md border bg-black py-2 text-white shadow-lg focus:outline-none">
              <Menu.Item
                as="button"
