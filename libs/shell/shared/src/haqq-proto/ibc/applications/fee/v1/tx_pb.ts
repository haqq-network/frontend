...
import { Fee, PacketFee } from './fee_pb';
...
export class MsgRegisterPayee extends Message<MsgRegisterPayee> {
  ...
  static equals(
    a: MsgRegisterPayee | PlainMessage<MsgRegisterPayee> | undefined,
    b: MsgRegisterPayee | PlainMessage<MsgRegisterPayee> | undefined,
  ): boolean {
...
export class MsgRegisterPayeeResponse extends Message<MsgRegisterPayeeResponse> {
  ...
  static equals(
    a:
      | MsgRegisterPayeeResponse
      | PlainMessage<MsgRegisterPayeeResponse>
      | undefined,
    b:
      | MsgRegisterPayeeResponse
      | PlainMessage<MsgRegisterPayeeResponse>
...
export class MsgRegisterCounterpartyPayee extends Message<MsgRegisterCounterpartyPayee> {
  ...
  static fromJsonString(
    ...
    return new MsgRegisterCounterpartyPayee().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | MsgRegisterCounterpartyPayee
      | PlainMessage<MsgRegisterCounterpartyPayee>
      | undefined,
    b:
      | MsgRegisterCounterpartyPayee
      | PlainMessage<MsgRegisterCounterpartyPayee>
...
export class MsgRegisterCounterpartyPayeeResponse extends Message<MsgRegisterCounterpartyPayeeResponse> {
  ...
  static fromBinary(
    ...
    return new MsgRegisterCounterpartyPayeeResponse().fromBinary(
      bytes,
      options,
    );
  }
  ...
  static fromJson(
    ...
    return new MsgRegisterCounterpartyPayeeResponse().fromJson(
      jsonValue,
      options,
    );
  }
  ...
  static fromJsonString(
    ...
    return new MsgRegisterCounterpartyPayeeResponse().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | MsgRegisterCounterpartyPayeeResponse
      | PlainMessage<MsgRegisterCounterpartyPayeeResponse>
      | undefined,
    b:
      | MsgRegisterCounterpartyPayeeResponse
      | PlainMessage<MsgRegisterCounterpartyPayeeResponse>
...
export class MsgPayPacketFee extends Message<MsgPayPacketFee> {
  ...
  static equals(
    a: MsgPayPacketFee | PlainMessage<MsgPayPacketFee> | undefined,
    b: MsgPayPacketFee | PlainMessage<MsgPayPacketFee> | undefined,
  ): boolean {
...
export class MsgPayPacketFeeResponse extends Message<MsgPayPacketFeeResponse> {
  ...
  static equals(
    a:
      | MsgPayPacketFeeResponse
      | PlainMessage<MsgPayPacketFeeResponse>
      | undefined,
    b:
      | MsgPayPacketFeeResponse
      | PlainMessage<MsgPayPacketFeeResponse>
...
export class MsgPayPacketFeeAsync extends Message<MsgPayPacketFeeAsync> {
  ...
  static equals(
    a: MsgPayPacketFeeAsync | PlainMessage<MsgPayPacketFeeAsync> | undefined,
    b: MsgPayPacketFeeAsync | PlainMessage<MsgPayPacketFeeAsync> | undefined,
  ): boolean {
...
export class MsgPayPacketFeeAsyncResponse extends Message<MsgPayPacketFeeAsyncResponse> {
  ...
  static fromJsonString(
    ...
    return new MsgPayPacketFeeAsyncResponse().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | MsgPayPacketFeeAsyncResponse
      | PlainMessage<MsgPayPacketFeeAsyncResponse>
      | undefined,
    b:
      | MsgPayPacketFeeAsyncResponse
      | PlainMessage<MsgPayPacketFeeAsyncResponse>
