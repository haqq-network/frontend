...
export class QueryInterchainAccountRequest extends Message<QueryInterchainAccountRequest> {
  ...
  static fromJsonString(
    ...
    return new QueryInterchainAccountRequest().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | QueryInterchainAccountRequest
      | PlainMessage<QueryInterchainAccountRequest>
      | undefined,
    b:
      | QueryInterchainAccountRequest
      | PlainMessage<QueryInterchainAccountRequest>
...
export class QueryInterchainAccountResponse extends Message<QueryInterchainAccountResponse> {
  ...
  static fromJsonString(
    ...
    return new QueryInterchainAccountResponse().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | QueryInterchainAccountResponse
      | PlainMessage<QueryInterchainAccountResponse>
      | undefined,
    b:
      | QueryInterchainAccountResponse
      | PlainMessage<QueryInterchainAccountResponse>
