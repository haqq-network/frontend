  ...
  return (
    <div className="m-auto rounded-[8px] bg-[#212122] pb-[32px] pl-[28px] pr-[28px] pt-[32px] text-[16px] font-[400] text-white">
      <div className="font-guise">
        ...
        Wave HAQQ Expedition on Galxe, but whose responses to the "MAIN HAQQ
        Wallet" prompt weren't saved in Galxe. To change the address, you must
        log in under the same wallet address as you passed the 3rd Wave of HAQQ
        Expedition on Galxe.
      </div>
