...
export function AboutBlock() {
  return (
    <div className="px-[16px] mx-[16px] sm:ml-[63px] lg:ml-[79px] border-l border-haqq-border flex flex-col sm:flex-row sm:h-[450px] lg:h-[500px] pb-[60px] sm:pb-0">
      ...
      <div className="pt-[16px] sm:pt-[60px] lg:pt-[140px] sm:pl-[22px] lg:pl-[32px] sm:border-l border-haqq-border flex-1 sm:pr-[64px] lg:pr-[80px]">
