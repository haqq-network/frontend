...
export function HeroBlock() {
  return (
    <div className="border-haqq-border relative border-b">
      <div className="border-haqq-border z-10 flex h-[500px] min-h-[440px] flex-col items-start justify-center px-[16px] sm:ml-[63px] sm:min-h-[610px] sm:border-l sm:pl-[20px] sm:pr-[64px] lg:ml-[79px] lg:min-h-[748px] lg:pl-[32px] lg:pr-[80px]">
        <HeroHeading>
          Home of <br />
          ethical web3
        </HeroHeading>
