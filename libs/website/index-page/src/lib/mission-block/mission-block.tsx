...
export function MissionBlock() {
  return (
    <div className="bg-white text-haqq-black px-[16px] sm:px-[63px] lg:pl-[79px] lg:pr-[80px] h-[326px] sm:h-[464px] lg:h-[600px] flex flex-col items-center justify-center relative">
      ...
      <div className="text-center mx-[44px] sm:max-w-xs lg:max-w-3xl">
        <Heading level={2} className="">
          Crypto has lost its path – grid-driven practices in crypto prevent
          mass adoption. HAQQ's mission is to make Web3 projects accessible to
          everyone.
        </Heading>
      </div>
