...
export function TextBlock() {
  return (
    <section className="flex flex-col gap-y-[20px] sm:gap-y-[24px] py-[60px] sm:py-[80px] lg:py-[100px] px-[16px] sm:px-[48px] lg:px-[110px] xl:px-[320px] border-b border-t border-white/20">
      <Heading>
      ...
      <Text>
        ...
        Fund, a grants and investment program designed to support the growth of
        Haqq Network and Islamic Coin. With a total allocation of $40M ($20M
        USDC and USDT + $20M Islamic Coin), the Haqq Ecosystem Fund represents
        our commitment to promoting global adoption of Haqq Blockchain and
        Islamic Coin.
      </Text>
      <Text>
      ...
      <Text>
        ...
        to the Haqq Network, and individual developers willing to contribute to
        the core haqq infrastructure products such as{' '}
        ...
        remains at the forefront of blockchain technology, serving as a hub for
