...
function GrayDescription({
  ...
  return (
    <div
      className={clsx(
        'font-guise text-[12px] font-semibold uppercase leading-[1.2em] text-white/50',
        className,
      )}
    >
      {children}
...
function DescriptionAmount({
  ...
  return (
    <div
      className={clsx(
        'font-clash text-[16px] font-medium uppercase leading-[20px] text-white',
        className,
      )}
    >
      {children}
...
export function ValidatorBlockMobileComponent({
  delegation,
  isDelegateDisabled,
  isGetRewardDisabled,
