...
import bgImgData from '../../assets/images/apply-block-background-lines.svg';

export function EcosystemFundApplyBlock() {
  return (
    <section
      className="relative z-[-1] mb-[-46px] flex h-[362px] flex-col items-center bg-cover bg-center bg-no-repeat px-[16px] pt-[48px] text-center font-light sm:h-[380px] sm:px-[48px] sm:pt-[60px] lg:h-[446px] 2xl:mb-[-26px]"
      id="apply"
      style={{
