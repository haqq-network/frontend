// ABI for UCDAO precompile contract at 0x0000000000000000000000000000000000000901
export const UcdaoAbi = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'islmAmount', type: 'uint256' },
    ],
    name: 'convertToHaqq',
    outputs: [{ internalType: 'uint256', name: 'haqqAmount', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
