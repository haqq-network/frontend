...
function BalancesDisplay({
  ...
  return (
    <div className="flex flex-col gap-[6px]">
      <div className="font-guise text-[12px] leading-[1.2em] font-semibold text-white/50 uppercase sm:text-[10px] lg:text-[12px]">
        {label}
      </div>

      <div className="font-clash flex flex-col flex-wrap gap-[28px] text-[24px] leading-[30px] font-medium text-white md:flex-row">
        {balances.map((token) => {
