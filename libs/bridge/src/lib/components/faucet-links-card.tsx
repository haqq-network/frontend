 ...
 */
export function FaucetLinksCard({ className = '' }: FaucetLinksCardProps) {
  ...
  return (
    <div
      className={`mt-[24px] rounded-[12px] border border-[#e5e7eb] bg-[#f9fafb] p-[20px] ${className}`}
    >
      <div className="mb-[16px] flex items-center gap-[8px]">
        ...
        <h3 className="text-[16px] font-[600] leading-[1.5] text-[#111827]">
          Need testnet tokens?
        </h3>
      </div>

      <p className="mb-[16px] text-[14px] leading-[1.5] text-[#6b7280]">
          ...
          return (
            ...
            >
              <div className="flex-1">
                <div className="text-[14px] font-[600] leading-[1.5] text-[#111827]">
                  {faucet.name}
                </div>
                <div className="text-[13px] leading-[1.5] text-[#6b7280]">
                  {faucet.description}
                </div>
              </div>
              <svg
      ...
      <div className="mt-[16px] rounded-[8px] bg-[#dbeafe] p-[12px]">
        <p className="text-[12px] leading-[1.5] text-[#1e40af]">
          <span className="font-[600]">Note:</span> These tokens have no real
