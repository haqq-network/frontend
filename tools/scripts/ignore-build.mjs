...
if (FORCE_BUILD_BRANCH === GIT_BRANCH_VERCEL) {
  console.log('current branch is prod, force build');
  process.exit(1);
} else {
  console.log(`current branch is not prod, check build need for "${APP}"`);
