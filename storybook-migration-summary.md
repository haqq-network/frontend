...
- `npx storybook@latest automigrate --config-dir apps/staking/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/ui-kit/.storybook --renderer @storybook/react`
